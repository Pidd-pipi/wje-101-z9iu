...
const (
	...
	LogBeanListAddSuccess    = "user bean list entry added: user_id=%d bean_id=%d"
	LogBeanListAddFailed     = "user bean list entry add failed: user_id=%d bean_id=%d"
	LogBeanListRemoveSuccess = "user bean list entry removed: user_id=%d bean_id=%d"
	LogBeanListGroupSuccess  = "user bean groups computed: user_id=%d"
