...
const (
	...
	LogUserBeanAddSuccess    = "user bean added to want list: user_id=%d bean_id=%d"
	LogUserBeanAddFailed     = "user bean add failed: user_id=%d bean_id=%d"
	LogUserBeanRemoveSuccess = "user bean removed from want list: user_id=%d bean_id=%d"
	LogUserBeanRemoveFailed  = "user bean remove failed: user_id=%d bean_id=%d"
	LogUserBeanTracked       = "user bean tracked after note: user_id=%d bean_id=%d"
	LogUserBeanGroupSuccess  = "user bean groups built: user_id=%d want=%d tasted=%d"
